...
#cria instancias com os IP
plc1 = maquina(listaEnderecos[0])
plc2 = maquina(listaEnderecos[1])
plc3 = maquina(listaEnderecos[2])
plc4 = maquina(listaEnderecos[3])
    ...
    if listaMaquinas[listaEnderecos[3]] == 1 :
        ...
        while tagStart:
            ...
            if (idRegistro > posicao_anterior[1] ):
                ...
                dados.append( plc4.host) #end_maquina
                dados.append(plc4.leDword(10000)) # ID_REGISTRO
                dados.append( plc4.leString(10002)) # NR_DOCUMENTO
                dados.append(plc4.leDword(10050) ) #NR_BATELADA
                dados.append( plc4.leWord(10069) ) #TIPO_BATELADA
                dados.append( plc4.LeDataHora(10017)) #H_INICIO
                dados.append( plc4.LeDataHora(10023) ) # H_FIM
                dados.append( plc4.leReal(10052) ) #Q_SEMENTE
                dados.append( plc4.leReal(10054)) # Q_COLA
                dados.append( plc4.leReal(10056))#Q_CORANTE
                dados.append( plc4.leReal(10058) )#Q_PO1
                dados.append(plc4.leReal(10060) )#Q_PO2
                dados.append( plc4.leWord(10062))#T_ALIMENTA_SEMENTE
                dados.append( plc4.leWord(10063) )#T_DOSA_COLA
                dados.append( plc4.leWord(10064) )#T_DOSA_CORANTE
                dados.append(plc4.leWord(10065) ) #T_DOSA_PO1
                dados.append(plc4.leWord(10066) )#T_DOSA_PO2
                dados.append( plc4.leWord(10067))#T_CICLO_PANELA
                dados.append( plc4.leWord(10068))#T_PAUSA 
